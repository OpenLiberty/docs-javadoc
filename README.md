...
11. Add the javadoc nav file and iframe files to the docs-generated repo.
    ...
    b. Copy the `feature-nav-api-openliberty.adoc` and `feature-nav-spi-openliberty.adoc` files from the `nav` directory of your local extracted copy of the 
